...
// ucid mab265 and date:04/24/2023
$results = [];
if (isset($_POST["itemName"]) || isset($_POST["itemCategory"])) {
    ...
    $stmt = $db->prepare("SELECT id, name, description, category, stock, unit_price, visibility FROM $TABLE_NAME WHERE name LIKE :name AND (category = :category OR :category = '') $orderBy LIMIT 50");
    try {
